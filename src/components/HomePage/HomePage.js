...
const HomePage = () => {
  return (
    <>
      ...
      <section className="py-24 bg-gray-100">
        <div className="container px-4 mx-auto">
          <div className="md:max-w-4xl mb-16 md:mb-20 ">
            <span className="inline-block py-px px-5 mb-4 text-lg leading-7 text-blue-500 bg-blue-100 font-medium uppercase rounded-full shadow-sm">
              INCOME & EXPENSES TRACKER
            </span>
            <h1 className="mb-4 text-3xl md:text-4xl leading-tight font-bold tracking-tighter">
              Track Your Plan Income and Expenses
            </h1>
          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
            <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
              <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-2xl transition duration-200">
            ...
            <div className="w-full   md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max">
                <img
                  src="https://img.freepik.com/premium-vector/budget-business-planning-financial-planning-flat-vector-illustration-banner-landing-page_128772-1074.jpg?w=360"
                  alt="home"
                />
              </div>
            </div>
      ...
      {/* Call to Action */}
      <section className="relative py-24 md:pb-32 bg-gray-100 overflow-hidden">
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            <span className="inline-block py-px px-2 mb-4 text-xl leading-5 text-blue-500 bg-blue-100 font-medium uppercase rounded-full shadow-sm">
              Get Started
            </span>
            ...
            <a
              className="inline-flex items-center justify-center px-7 py-3 h-14 w-full md:w-auto text-lg leading-5 text-green-50 bg-blue-500 hover:bg-blue-600 font-medium focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm"
              href="#"
            >
              Get Started
            </a>
          ...
          <div className="relative max-w-4xl mx-auto">
            <img
              className="relative"
              src="https://dm0qx8t0i9gc9.cloudfront.net/thumbnails/video/UsHIP34/videoblocks-close-up-details-man-sitting-at-the-white-desk-typing-on-keyboard-laptop-male-wearing-bright-blue-shirt-working-use-computer_r1ggg47_ov_thumbnail-1080_01.png"
              alt="landing"
            />
          </div>
        </div>
